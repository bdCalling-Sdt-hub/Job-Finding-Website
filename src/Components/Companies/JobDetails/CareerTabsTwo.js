    ...
    return (
        <div className="relative">
                ...
                {articles.map((article) => (
                    ...
                    >
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <Link href="/company/careerresources/edit" className="bg-[#553283] text-white px-5 py-2 rounded text-xs hover:bg-[#553283]">Edit</Link>
                            <button
                                title="View"
            ...
            <div className="absolute bottom-5 right-0">
                <Link href="/company/careerresources/addnet" className="w-16 h-16 bg-[#553283] text-white rounded-full flex items-center justify-center"><LuPlus className="text-4xl" /></Link>
            </div>
