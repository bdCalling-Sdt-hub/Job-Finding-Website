        ...
        <div className="p-6">
            ...
            <Form name="basic" onFinish={handleSubmit} layout="vertical">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <h3 className='text-base font-medium mb-2'>Upload Overview Related Picture</h3>
                        <Form.Item>
                            <Dragger
                                action="/upload"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <h3 className='text-base font-medium mb-2'>Upload Vision Picture</h3>
                        <Form.Item>
                            <Dragger
                                action="/upload"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <h3 className='text-base font-medium mb-2'>Upload Core Values Picture</h3>
                        <Form.Item>
                            <Dragger
                                action="/upload"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <h3 className='text-base font-medium mb-2'>Upload Commitment Picture</h3>
                        <Form.Item>
                            <Dragger
                                action="/upload"
                ...
                <div className="">
                    <div>
                        <h3 className='text-base font-medium mb-2'>Upload Pictures/Videos of Cultural Activities</h3>
                        <Form.Item>
                            <Dragger
                                action="/upload"
