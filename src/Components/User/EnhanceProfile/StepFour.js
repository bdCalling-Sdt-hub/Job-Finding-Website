    ...
    return (
        <div>
            <div className='flex justify-center my-10'>
                <span className='text-3xl font-semibold'>Step 4</span>
            </div>
            ...
            <div className="p-6 w-full rounded-2xl border border-[#7ed957] mx-auto ">
                ...
                <p className="text-sm text-gray-600 0">
                ...
                <hr className='md:my-14 my-8 h-[1px] bg-[#7ed957] border-none' />
            ...
            <div className='flex justify-center mt-10'>
                <button className='bg-[#7ed957] text-white font-semibold cursor-pointer py-3 w-[200px] rounded capitalize text-center ' onClick={handleNextStep}>Save </button>
            </div>
        </div>
    );
}
