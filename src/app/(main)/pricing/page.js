...
const Page = () => {
    return (
        <div className='w-[90%] mx-auto my-10'>
            ...
            <div className='grid grid-cols-3 lg:w-2/3 mx-auto items-start justify-center gap-5 py-10 '>
                {
                    [...Array(3)].map((_, index) =>
                        <div key={index} className=''>
                            <div className='bg-[#553283] w-full p-5 rounded-lg text-white mt-10 border-r-2 border-b-2 border-[#7ed957]'>
                                <h2 className='text-4xl font-medium'>€{(Math.random() * 100).toFixed(2)} <span className='text-sm'>/monhly</span></h2>
                                <h3 className='text-3xl font-medium my-5 uppercase'>Basic Plan {++index}</h3>
