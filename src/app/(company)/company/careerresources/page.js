'use client';
import CareerTabsOne from '@/Components/Companies/JobDetails/CareerTabsOne';
import CareerTabsTwo from '@/Components/Companies/JobDetails/CareerTabsTwo';
        ...
        <div>
            ...
            <div className="flex border-b border-gray-300 mb-4 text-lg font-medium">
                <button
                    ...
                    className={`pb-2 px-4 cursor-pointer border-b-2 ${activeTab === 'articleBlogs'
                ...
                <button
                    ...
                    className={`pb-2 px-4 cursor-pointer border-b-2 ml-8 ${activeTab === 'networkingEvents'
                        ? 'border-black font-semibold'
                        : 'border-transparent text-gray-500'
                        }`}
                >
