...
import TabsOne from '@/Components/Companies/JobDetails/TabsOne';
import TabsTwo from '@/Components/Companies/JobDetails/TabsTwo';
    ...
    return (
        <div style={{ padding: '24px' }}>
            ...
            <div className="flex items-center gap-2 text-3xl font-medium mb-6">
                <FaChevronLeft />
                <Link href="/company/joblisting">Job Posting Details</Link>
            </div>
